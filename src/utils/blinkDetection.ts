...
export const BLINK_THRESHOLD = 0.28; // Lowered threshold for more accurate detection
export const BLINK_BUFFER = 0.04;    // Increased buffer to prevent false reopens
